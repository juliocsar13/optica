    ...
    <main class="main">
            ...
            <div class="container-fluid">
                        ...
                        <div class=" row">
                              <div class="form-group col-md-3">
                                <div class="form-group">
                                  ...
                                  <input id='datePago' placeholder="date" class="form-control"/>
                                </div>
                              </div>
                              <div class="form-group col-md-3">
                              ...
                              <div class="col-md-12">
                                <button class="btn btn-success pull-right" @click='filterPago()'>Filtrar</button>
                              </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                      <i class="fa fa-align-justify" style="margin-top: 8px;"></i> Cuentas por pagar
                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="ingreso in arrayIngreso" :key="ingreso.id">
                                        ...
                                        <td v-text="ingreso.pendienteI"></td>
                                        <td>
    ...
    export default {
        ...
        methods : {
            generatePDF() {
              ...
              let date = $('#datePago').val().split('-');

              let dateStart = date[0];
              let dateEnd = date[1];

              var url= '/pago/filter?tipo_comprobante=' + tipo + '&num_comprobante='+ num + '&dateEnd='+ dateEnd+ '&dateStart='+dateStart+ '&type=report';
            ...
            filterPago() {
              ...
              let dateStart = date[0];
              let dateEnd = date[1];
              var url= '/pago/filter?tipo_comprobante=' + tipo + '&num_comprobante='+ num + '&dateEnd='+ dateEnd+ '&dateStart='+dateStart+' &type=filter';

              let me=this;
              axios.get(url).then(function (res) {
                me.arrayIngreso = res.data.ventas;
              })
            ...
            verIngreso(id){
                ...
                var arrayIngresoT=[];
                var url= '/pago/obtenerCabecera?id=' + id;

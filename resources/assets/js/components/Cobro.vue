            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button class="btn btn-outline-secondary pull-right" @click='generatePDF()'  style="margin-top:1px">Generar reporte</button>
                    </div>
                        ...
                        <div class=" row">
                              <!--<div class="form-group col-md-3">
                                <div class="form-group">
                                  ...
                                  <input type="date" v-model="filterDate" placeholder="date" class="form-control"/>
                                </div>
                              </div>-->
                              <div class="form-group col-md-3">
                                <div class="form-group">
                                  <label for="">Rango de Fecha</label>
                                  <input id="dateCobro"  class="form-control" style="height: 39px;"/>
                                </div>
                              </div>
                              <div class="form-group col-md-3">
                                <label for="">Tipo Combrobante</label>
                                <select  class="form-control" v-model="tipo_comprobante" style="height:39px">
                              ...
                              <div class="form-group col-md-3">
                                ...
                                <input style="height:39px" type="text" v-model="num_comprobante" class="form-control">
                              </div>
                              <div class="col-md-12">
                                <button class="btn btn-success pull-right" @click='filterCobro()'>Filtrar</button>
                              </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                      <i class="fa fa-align-justify" style="margin-top: 8px;"></i> Cuentas por cobrar
...
<script>
    ...
    export default {
        ...
        methods : {
            filterCobro(){
              let tipo = this.tipo_comprobante;
              let num = this.num_comprobante;
              let date = $('#dateCobro').val().split("-");
              let dateStart = date[0];
              let dateEnd = date[1];
              var url= '/cobro/filter?tipo_comprobante=' + tipo + '&num_comprobante='+ num + '&dateEnd='+ dateEnd+ '&dateStart='+dateStart+' &type=filter';

              let me=this;
              axios.get(url).then(function (res) {
                me.arrayVenta = res.data.ventas;
              })
            ...
            generatePDF() {
              ...
              let dateStart = date[0];
              let dateEnd = date[1];
              var url= '/cobro/filter?tipo_comprobante=' + tipo + '&num_comprobante='+ num + '&dateEnd='+ dateEnd+ '&dateStart='+dateStart+ '&type=report';

              window.open(url);
            },
            listarVenta (page,buscar,criterio){
                let me=this;
                var url= '/cobro?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;

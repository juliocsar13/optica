        ...
        <tr>
          ...
          <td style="text-align:center">
            <div style="text-align:center;padding:28px;width:230px;height:250px;background-color:#212121;color:white;position:absolute;top:-65px;left:400px;">
              <h1 style="color:white;margin-top:50px; font-size:50px">COBROS</h1>
              <table style="margin-top:50px">
                <tr>
                  <td style="text-align:left">Usuario</td>
                  <td style="text-align:right">{{$cliente->nombre}}</td>
                </tr>
                <tr>
            ...
            <tr>
              <td style="width:60%">
                <strong class="margin-bottom-5">
                  <h5>REPORTE DE </h5>
                  <h4 style="font-weight: bold">CUENTAS POR COBRAR</h4>
                </strong>
              </td>
            </tr>
            <tr >
          ...
          @foreach($ventas as $key => $venta)
            <tr>
              ...
              <td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;background-color:#d4d4d4"><div class="subtitle">S/{{$venta->total}}</div></td>
    					<td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;"><div class="subtitle">S/{{$venta->adelanto}}</div></td>

          ...
          @foreach($ventas as $key => $venta)
            <tr>
              ...
              <td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;background-color:#d4d4d4"><div class="subtitle">S/{{$venta->total}}</div></td>
    					<td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;"><div class="subtitle">S/{{$venta->adelantoI}}</div></td>
              <td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;background-color:#d4d4d4"><div class="subtitle">S/{{$venta->pendienteI}}</div></td>
    				</tr>
          @endforeach

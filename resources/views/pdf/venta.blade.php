              ...
              <tr>
                ...
                <th  >
                  <div style="position:absolute; margin-top:30px;text-align:center" class="data-credentials" >
                    ...
                    <div class="data-credentials-boleta"> BOLETA DE VENTA</div>
            ...
            <thead >
              <tr>
                <th>Lima, <div class="data-cliente-day">{{$info->day}}</div> de
                          ...
                          <div class="data-cliente-year">{{$info->year}}</div></th>
              </tr>
              <tr>
          ...
          <table style=" width: 100%; margin-top: 15px">
            <tr>
              ...
              <th class="table-header-total" style="width:25%;border-radius: 30px;padding:20px">
                Total S/. <div style="margin-top:3px;display:inline-block;">{{$total->total}}</div>
              </th>
            </tr>

        ...
        <tr>
          ...
          <td style="text-align:center">
            <div style="text-align:center;padding:28px;width:230px;height:250px;background-color:#212121;color:white;position:absolute;top:-65px;left:400px;">
              <h1 style="color:white;margin-top:50px; font-size:50px">COMPRAS</h1>
              <table style="">
                <tr>
                  <td style="text-align:left">Proveedor</td>
                  @if(Request::query('filterProveedor') != 'undefined')
                ...
                <tr>
                  <td style="text-align:left">Fecha Filtro</td>
                  @if(Request::query('date') != '')
                    <td style="text-align:right">{{ Request::query('date') }}</td>
                  @else
                    <td style="text-align:right">-</td>
                  @endif
                </tr>
                <tr>
                  ...
                  @if(Request::query('tipo_compra') != '')
                    <td style="text-align:right">{{ Request::query('tipo_compra') }}</td>
                  @else
                    <td style="text-align:right">-</td>
                  @endif
                </tr>
                <tr>
                  ...
                  @if(Request::query('comprobante') != '')
                    <td style="text-align:right">{{ Request::query('comprobante') }}</td>
                  @else
                    <td style="text-align:right">-</td>
                  @endif
                </tr>
                ...
                <tr>
                  ...
                  <td style="text-align:right">S/.{{$totales}}</td>
                </tr>
              </table>
            </div>
          </td>
            ...
            <tr>
              <td style="width:60%">
                <strong class="margin-bottom-5">
                  <h5>REPORTE DE </h5>
                  <h4 style="font-weight: bold">COMPRAS</h4>
                </strong>
              </td>
            </tr>
            <tr >
  	...
  	<div class="row">
  		<div class="col-md-12">
            ...
            <th class="table-cobro" style="width:50px"><div class="title">#</div></th>
  					<th class="table-cobro"><div class="title">CLIENTE</div></th>
          ...
          <!--  <th class="table-cobro"><div class="title">PENDIENTE</div></th>-->
  				</tr>
          @foreach($ventas as $key => $venta)
            <tr>
              <td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;background-color:#d4d4d4"><div class="subtitle">{{$key+1}}</div></td>
    					<td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;"><div class="subtitle">{{$venta->nombre }}</div></td>
    					<td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;background-color:#d4d4d4"><div class="subtitle">{{$venta->num_documento}}</div></td>
    					<td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;"><div class="subtitle">{{$venta->serie_comprobante}} - {{$venta->num_comprobante}}</div></td>
              <td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;background-color:#d4d4d4"><div class="subtitle">S/{{$venta->total}}</div></td>
    					<td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;border-right: 1px solid #bcbbbe;"><div class="subtitle">S/{{$venta->adelanto}}</div></td>
              <!--<td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;background-color:#d4d4d4"><div class="subtitle">S/{{$venta->pendiente}}</div></td>
-->
          	</tr>
          @endforeach
          <tr  style="margin-top:100px;position:absolute;top:20px">
            ...
            <td class="total-bottom table-content" style="border: 1px solid #bcbbbe;"><span><div class="subtitle">S/{{$totales}}</div></span></td>
          </tr>
  			</table>

  ...
  <div>
    ...
    <?php endif; ?>
          ...
          <tr>
            ...
            <td class="content-td table-content" style="border-bottom: 1px solid #ddd;background-color:#d4d4d4"><div class="subtitle">S/<?php echo e($total_cobros_contado-$total_ingresos_contado); ?>.00</div></td>
          ...
          <tr>
            ...
            <td class="content-td table-content" style="border-bottom: 1px solid #ddd;background-color:#d4d4d4"><div class="subtitle">S/<?php echo e($total_cobros-$total_ingresos); ?>.00</div></td>

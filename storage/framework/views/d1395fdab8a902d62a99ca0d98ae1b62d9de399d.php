            ...
            <div style="text-align:center;padding:28px;width:230px;height:250px;background-color:#212121;color:white;position:absolute;top:-65px;left:400px;">
              ...
              <table style="">
                <tr>
                  ...
                  <?php if(Request::query('filterProveedor') != 'undefined'): ?>
                    <td style="text-align:right"><?php echo e($proveedor); ?></td>
                  <?php else: ?>
                ...
                <tr>
                  ...
                  <?php if(Request::query('date') != ''): ?>
                    <td style="text-align:right"><?php echo e(Request::query('date')); ?></td>
                  <?php else: ?>
                    <td style="text-align:right">-</td>
                  <?php endif; ?>
                </tr>
                <tr>
                  ...
                  <?php if(Request::query('tipo_compra') != ''): ?>
                    <td style="text-align:right"><?php echo e(Request::query('tipo_compra')); ?></td>
                  <?php else: ?>
                    <td style="text-align:right">-</td>
                  <?php endif; ?>
                </tr>
                <tr>
                  ...
                  <?php if(Request::query('comprobante') != ''): ?>
                    <td style="text-align:right"><?php echo e(Request::query('comprobante')); ?></td>
                  <?php else: ?>
                    <td style="text-align:right">-</td>
                  <?php endif; ?>
                </tr>
          ...
          <?php $__currentLoopData = $ventas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $venta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;background-color:#d4d4d4"><div class="subtitle">S/<?php echo e($venta->total); ?></div></td>
    					<td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;border-right: 1px solid #bcbbbe;"><div class="subtitle">S/<?php echo e($venta->adelanto); ?></div></td>
              <!--<td  class="content-td table-content" style="border-bottom: 1px solid #bcbbbe;background-color:#d4d4d4"><div class="subtitle">S/<?php echo e($venta->pendiente); ?></div></td>
-->
          	</tr>

            ...
            <div style="text-align:center;padding:28px;width:230px;background-color:#212121;color:white;position:absolute;top:-65px;left:650px;">
              ...
              <table style="line-height:normal">
                <tr>
                  ...
                  <td style="text-align:right"><?php echo e(Request::get('dateStart')); ?></td>
                </tr>
                <tr>
                  <td style="text-align:left">Fecha final</td>
                  <td style="text-align:right"><?php echo e(Request::get('dateEnd')); ?></td>
                </tr>
                <tr>
                  <td style="text-align:left">Productos</td>
                  <td style="text-align:right"><?php echo e($producto); ?></td>
                </tr>
                <tr>
    ...
    <div class="row" style="padding: 10px;margin-left:50px">
  	...
  	<div class="row" style="margin-top:-40px;padding:25px">
          ...
          <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
    					<td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($producto->fecha); ?> </td>
              <td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($producto->serie_comprobante); ?></td>
              <td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($producto->num_comprobante); ?></td>

    					<td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($producto->i_cantidad); ?></td>
    					<td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($producto->i_precio); ?></td>
              <td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($producto->i_total); ?></td>

              <td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($producto->v_cantidad); ?></td>
              <td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($producto->v_precio); ?></td>
              <td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($producto->v_total); ?></td>

              <td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($producto->t_cantidad); ?></td>
              <td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($producto->t_precio); ?></td>
              <td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($producto->t_total); ?></td>
          	</tr>
          ...
          <tr>
            ...
            <td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($total_ingreso_cantidad); ?></td>
            <td class="content-td" style="border-bottom: 1px solid #ddd;"></td>
            <td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($total_ingreso); ?></td>

            <td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($total_salida_cantidad); ?></td>
            <td class="content-td" style="border-bottom: 1px solid #ddd;"></td>
            <td class="content-td" style="border-bottom: 1px solid #ddd;"><?php echo e($total_salida); ?></td>
